...
public class HeldItemRuleConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(CycleButton.<HeldItemRuleManager.RuleMode>builder(HeldItemRuleManager.RuleMode::label, this.ruleMode)
    ...
    private final class SelectorEntryPreview extends AbstractWidget {
        ...
        protected void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
            ...
            graphics.drawString(font, this.selector, getX() + 20, getY() + 6, opaque(0xE0E6EE), false);
        }
    ...
    private final class CustomRulePreview extends AbstractWidget {
        ...
        @Override
        protected void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
            graphics.drawString(font, Component.literal(this.rule.displayName()), getX(), getY() + 2, opaque(0xFFFFFF), false);
            graphics.drawString(font,
                    Component.translatable("screen.itemglint.rule_editor.rule_row_meta", this.rule.priority(), this.rule.filters().size()),
                    getX(), getY() + 12, opaque(0xAAB3C3), false);
        }
